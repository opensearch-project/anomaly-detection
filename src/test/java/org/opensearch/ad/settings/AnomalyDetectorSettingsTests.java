...
public class AnomalyDetectorSettingsTests extends OpenSearchTestCase {
    ...
    public void testAllLegacyOpenDistroSettingsFallback() {
        ...
        assertEquals(
            AnomalyDetectorSettings.AD_RESULT_HISTORY_MAX_DOCS.get(Settings.EMPTY),
            LegacyOpenDistroAnomalyDetectorSettings.AD_RESULT_HISTORY_MAX_DOCS.get(Settings.EMPTY)
        );
        assertEquals(
        ...
        assertEquals(
            AnomalyDetectorSettings.INDEX_PRESSURE_SOFT_LIMIT.get(Settings.EMPTY),
            LegacyOpenDistroAnomalyDetectorSettings.INDEX_PRESSURE_SOFT_LIMIT.get(Settings.EMPTY)
        );
        assertEquals(
        ...
        assertEquals(
            AnomalyDetectorSettings.MAX_CACHE_MISS_HANDLING_PER_SECOND.get(Settings.EMPTY),
            LegacyOpenDistroAnomalyDetectorSettings.MAX_CACHE_MISS_HANDLING_PER_SECOND.get(Settings.EMPTY)
        );
        assertEquals(
    ...
    public void testSettingsGetValue() {
        Settings settings = Settings.builder().put("opensearch.anomaly_detection.request_timeout", "42s").build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_anomaly_detectors", 99).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_multi_entity_anomaly_detectors", 98).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_anomaly_features", 97).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.detection_interval", TimeValue.timeValueMinutes(96)).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.detection_window_delay", TimeValue.timeValueMinutes(95)).build();
        ...
        settings = Settings
            .builder()
            .put("opensearch.anomaly_detection.ad_result_history_rollover_period", TimeValue.timeValueHours(94))
            .build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.ad_result_history_max_docs", 93).build();
        assertEquals(AnomalyDetectorSettings.AD_RESULT_HISTORY_MAX_DOCS.get(settings), Long.valueOf(93));
        assertEquals(LegacyOpenDistroAnomalyDetectorSettings.AD_RESULT_HISTORY_MAX_DOCS.get(settings), Long.valueOf(250000000));

        settings = Settings
            .builder()
            .put("opensearch.anomaly_detection.ad_result_history_retention_period", TimeValue.timeValueDays(92))
            .build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_retry_for_unresponsive_node", 91).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.cooldown_minutes", TimeValue.timeValueMinutes(90)).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.backoff_minutes", TimeValue.timeValueMinutes(89)).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.backoff_initial_delay", TimeValue.timeValueMillis(88)).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_retry_for_backoff", 87).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_retry_for_end_run_exception", 86).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.filter_by_backend_roles", true).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.model_max_size_percent", 0.3).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_entities_per_query", 83).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_entities_for_preview", 82).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.index_pressure_soft_limit", 81f).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_primary_shards", 80).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_cache_miss_handling_per_second", 79).build();
        assertEquals(AnomalyDetectorSettings.MAX_CACHE_MISS_HANDLING_PER_SECOND.get(settings), Integer.valueOf(79));
        assertEquals(LegacyOpenDistroAnomalyDetectorSettings.MAX_CACHE_MISS_HANDLING_PER_SECOND.get(settings), Integer.valueOf(100));

        settings = Settings.builder().put("opensearch.anomaly_detection.max_batch_task_per_node", 78).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.max_old_ad_task_docs_per_detector", 77).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.batch_task_piece_size", 76).build();
        ...
        settings = Settings.builder().put("opensearch.anomaly_detection.batch_task_piece_interval_seconds", 76).build();
    ...
    public void testSettingsGetValueWithLegacyFallback() {
        ...
        assertEquals(AnomalyDetectorSettings.AD_RESULT_HISTORY_MAX_DOCS.get(settings), Long.valueOf(8L));
        ...
        assertEquals(AnomalyDetectorSettings.INDEX_PRESSURE_SOFT_LIMIT.get(settings), Float.valueOf(20F));
        assertEquals(AnomalyDetectorSettings.MAX_PRIMARY_SHARDS.get(settings), Integer.valueOf(21));
        assertEquals(AnomalyDetectorSettings.MAX_CACHE_MISS_HANDLING_PER_SECOND.get(settings), Integer.valueOf(22));
