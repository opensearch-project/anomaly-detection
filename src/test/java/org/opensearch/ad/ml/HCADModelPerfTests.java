...
public class HCADModelPerfTests extends AbstractCosineDataTest {
    ...
    private void averageAccuracyTemplate(
        ...
        // set up detector
        // We need the detector object as EntityColdStarter.getEntityColdStartData requires a full detector and
        ...
        detector = TestHelpers.AnomalyDetectorBuilder
            ...
            // the categories given earlier when creating the detector and going through cold start don't matter
            // as we ensure train and predict using the same entity name later
    ...
    public void testAverageAccuracyIndependent() throws Exception {
        ...
        // 5 minute interval, 4 features
        averageAccuracyTemplate(5, 0.3f, 0.1f, 4, true);
