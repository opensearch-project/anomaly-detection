...
public class ADRestTestUtils {
    ...
    public static TaskProfile<ADTask> getADTaskProfile(RestClient client, String detectorId) throws IOException {
    ...
    public static TaskProfile<ADTask> parseADTaskProfile(Response profileResponse) throws IOException {
