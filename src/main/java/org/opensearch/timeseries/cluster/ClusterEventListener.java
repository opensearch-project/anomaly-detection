...
public class ClusterEventListener implements ClusterStateListener {
    private static final Logger LOG = LogManager.getLogger(ClusterEventListener.class);
    public static final String NOT_RECOVERED_MSG = "Cluster is not recovered yet.";
    public static final String IN_PROGRESS_MSG = "Cluster state change in progress, return.";
    public static final String NODE_CHANGED_MSG = "Cluster node changed";
    ...
    @Inject
    public ClusterEventListener(ClusterService clusterService, HashRing hashRing) {
