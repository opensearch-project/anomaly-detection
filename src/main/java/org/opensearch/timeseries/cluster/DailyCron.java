...
public class DailyCron implements Runnable {
    ...
    public static final String CANNOT_DELETE_OLD_CHECKPOINT_MSG = "Cannot delete old checkpoint.";
    public static final String CHECKPOINT_NOT_EXIST_MSG = "Checkpoint index does not exist.";
    public static final String CHECKPOINT_DELETED_MSG = "checkpoint docs get deleted";
