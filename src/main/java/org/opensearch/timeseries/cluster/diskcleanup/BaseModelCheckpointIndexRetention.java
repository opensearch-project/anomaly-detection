 ...
 * </p>
 */
public class BaseModelCheckpointIndexRetention implements Runnable {
    private static final Logger LOG = LogManager.getLogger(BaseModelCheckpointIndexRetention.class);
    ...
    public BaseModelCheckpointIndexRetention(
