...
public class InsightsJobActionHandler {
    ...
    public void startInsightsJob(String frequency, ActionListener<InsightsJobResponse> listener) {
        ...
        //
        // For REST calls, the Security plugin already populated the authenticated user context in thread context.
        // Injecting roles here is unnecessary and can be harmful (it may overwrite/misrepresent the real user/roles).
