...
public final class AnomalyCorrelation {
    ...
    */
     ...
     * Singleton components (isolated anomalies) are included as single-item clusters.
     */
    ...
    public static List<Cluster> clusterWithEventWindows(List<Anomaly> anomalies) {
        List<List<Anomaly>> clusters = cluster(anomalies);
    ...
    public static List<List<Anomaly>> cluster(List<Anomaly> anomalies) {
        return cluster(anomalies, DELTA_TOL, KAPPA, ALPHA, MIN_OVERLAP, MODE, LAM, TAU_CONTAIN, RHO_MAX, CONTAINMENT_RELAX);
    }
}
