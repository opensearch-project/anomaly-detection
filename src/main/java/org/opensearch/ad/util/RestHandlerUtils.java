...
public final class RestHandlerUtils {
    ...
    public static final String EXTENSION_JOB_PARAMETER_ACTION_NAME = "get_extension_job_parameter";
    public static final String EXTENSION_JOB_RUNNER_ACTION_NAME = "get_extension_job_runner";
