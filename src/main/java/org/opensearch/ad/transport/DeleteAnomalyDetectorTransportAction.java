...
public class DeleteAnomalyDetectorTransportAction extends TransportAction<DeleteAnomalyDetectorRequest, DeleteResponse> {
    ...
    @Override
    public void doExecute(Task task, DeleteAnomalyDetectorRequest request, ActionListener<DeleteResponse> actionListener) {
    ...
    private void deleteAnomalyDetectorJobDoc(String detectorId, ActionListener<DeleteResponse> listener) {
        LOG.info("Delete anomaly detector job {}", detectorId);
        DeleteRequest deleteRequest = new DeleteRequest(ANOMALY_DETECTOR_JOB_INDEX, detectorId)
