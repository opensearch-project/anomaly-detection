...
public class EntityModel {
     ...
     */
    public EntityModel(Entity entity, Queue<double[]> samples, ThresholdedRandomCutForest ercf) {
        this.entity = entity;
        this.samples = samples;
        this.ercf = ercf;
    }
     ...
     */
    public void setErcf(ThresholdedRandomCutForest ercf) {
        this.ercf = ercf;
    }
     ...
     */
    public Optional<ThresholdedRandomCutForest> getErcf() {
