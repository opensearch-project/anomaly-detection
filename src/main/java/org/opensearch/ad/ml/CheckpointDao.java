...
public class CheckpointDao {
    ...
    public CheckpointDao(
        ...
        ThresholdedRandomCutForestMapper ercfMapper,
        Schema<ThresholdedRandomCutForestState> ercfSchema,
    ...
    private String toCheckpoint(ThresholdedRandomCutForest ercf) {
    ...
    private String toCheckpoint(ThresholdedRandomCutForest ercf, LinkedBuffer buffer) {
        try {
            ThresholdedRandomCutForestState ercfState = ercfMapper.toState(ercf);
    ...
    public Optional<Entry<EntityModel, Instant>> fromEntityModelCheckpoint(Map<String, Object> checkpoint, String modelId) {
        try {
            return AccessController.doPrivileged((PrivilegedAction<Optional<Entry<EntityModel, Instant>>>) () -> {
                ...
                ThresholdedRandomCutForest ercf = null;
    ...
    private ThresholdedRandomCutForest toErcf(String checkpoint) {
        ThresholdedRandomCutForest ercf = null;
        if (checkpoint != null) {
            try {
                byte[] bytes = Base64.getDecoder().decode(checkpoint);
                ThresholdedRandomCutForestState ercfState = ercfSchema.newMessage();
